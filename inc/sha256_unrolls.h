...
#define SHA256_COMPRESS_8X_GPU                                 \
    for (i = 0; i < 64; i += 8) {                            \
        ...
        a = t1 + t2;                                    \
                                                        \
        t1 = h + EP1(e) + CH(e,f,g) + k_[i+1] + m[i+1];    \
        t2 = EP0(a) + MAJ(a,b,c);                        \
        h = g;                                            \
        g = f;                                            \
        f = e;                                            \
        ...
        a = t1 + t2;                                    \
                                                        \
        t1 = h + EP1(e) + CH(e,f,g) + k_[i+2] + m[i+2];    \
        t2 = EP0(a) + MAJ(a,b,c);                        \
        h = g;                                            \
        g = f;                                            \
        f = e;                                            \
        ...
        a = t1 + t2;                                    \
                                                        \
        t1 = h + EP1(e) + CH(e,f,g) + k_[i+3] + m[i+3];    \
        t2 = EP0(a) + MAJ(a,b,c);                        \
        h = g;                                            \
        g = f;                                            \
        f = e;                                            \
        ...
        a = t1 + t2;                                    \
                                                        \
        t1 = h + EP1(e) + CH(e,f,g) + k_[i+4] + m[i+4];    \
        t2 = EP0(a) + MAJ(a,b,c);                        \
        h = g;                                            \
        g = f;                                            \
        f = e;                                            \
        ...
        a = t1 + t2;                                    \
                                                        \
        t1 = h + EP1(e) + CH(e,f,g) + k_[i+5] + m[i+5];    \
        t2 = EP0(a) + MAJ(a,b,c);                        \
        h = g;                                            \
        g = f;                                            \
        f = e;                                            \
        ...
        a = t1 + t2;                                    \
                                                        \
        t1 = h + EP1(e) + CH(e,f,g) + k_[i+6] + m[i+6];    \
        t2 = EP0(a) + MAJ(a,b,c);                        \
        h = g;                                            \
        g = f;                                            \
        f = e;                                            \
        ...
        a = t1 + t2;                                    \
                                                        \
        t1 = h + EP1(e) + CH(e,f,g) + k_[i+7] + m[i+7];    \
        t2 = EP0(a) + MAJ(a,b,c);                        \
        h = g;                                            \
        g = f;                                            \
        f = e;                                            \
